...
import 'package:myproject/pages/widgets/header_widget.dart';
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                title: Text('Forgot Password Page',style: TextStyle(fontSize: _drawerFontSize,color: Theme.of(context).colorScheme.secondary),),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text('Verification Page',style: TextStyle(fontSize: _drawerFontSize,color: Theme.of(context).colorScheme.secondary),),
                onTap: () {
